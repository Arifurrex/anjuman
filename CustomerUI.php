<section class="anjumanmember">
     <!-- <div class="title">
          <h3>সদস্যবৃন্দ</h3>
          <p class="subtitle">আঞ্জুমানে হেফাজত এর সকল  সদস্যবৃন্দ </p>
     </div> -->
    <div class="wrappercus">
      ...
      <div class="main-container">
        ...
        <!-- navigation bar end herer  -->
        <!-- user-box first-box s here  -->
        <div class="user-box first-box">
          <div class="activity card" style="--delay: 0.2s">
            ...
            <div class="title">
            <h3>সদস্যবৃন্দ</h3>
             <p class="subtitle paragraph">আঞ্জুমানে হেফাজত এর সকল  সদস্যবৃন্দ </p>
            </div>
              <div class="destination-card">
                ...
                <div class="destination-points">
                  <div class="point">প্রধান পৃষ্ঠপোষক ও সম্পাদকমন্ডলীর সভাপতি  আমীরে  আঞ্জুমানে হেফাজতে  ইসলাম   </div>
                  <div class="sub-point paragraph">
                    আল্লামা মুফতি মুহা. রশিদুর রহমান ফারুক বর্ণভী (পীর সাহেব বরুনা)
                  </div>
                  <div class="point">উপদেষ্টামন্ডলী </div>
                  <div class="sub-point paragraph">
                    <li> মাওলানা সাইদুর রহমান হামিদী <li>
                    <li>মাওলানা আব্দুল বারী ধর্মপুরী <li>
                    <li>অধ্যাপক মাওলানা জুবায়ের আহমেদ চৌধুরী<li>
                    <li>মাওলানা ওলিউর রহমান বর্ণভী <li>
                    <li>মাওলানা  শেখ নূরে আলম হামিদী <li>
                    <li>মাওলানা শেখ বদরুল আলম হামিদী <li>
                    <li>মাওলানা সৈয়দ মুজাদ্দিদ আলী  <li>
                  </div>
                  <div class="point">সম্পাদনা পরিষদ</div>
                  <div class="sub-point paragraph">
                  <li>মাওলানা আবদাল হোসেন খান  <li>
                  <li>মাওলানা শাহ নজরুল ইসলাম <li>
                  <li>অধ্যাপক মাওলানা মোহাম্মদ আব্দুস সবুর  <li>
                  </div>
                  <div class="point">নির্বাহী সম্পাদক</div>
                  <div class="sub-point paragraph">
                  <li>শেখ সা`দ আহমদ আমিন বর্ণভী  <li>
                  </div>
                  <div class="point">সহযোগী সম্পাদক </div>
                  <div class="sub-point paragraph">
                  <li>মাওলানা শাব্বীর আহমদ ফতেহপুরী <li>
                  </div>
                  <div class="point">সহকারী সম্পাদক </div>
                  <div class="sub-point paragraph">
                  <li>মাওলানা শেখ হাদী আলম হামিদী <li>
                  <li>মাওলানা জাবেদ আহমদ হায়দরগঞ্জী  <li>
                  </div>
                </div>
              </div>
              <!-- <div class="destination-card">
          ...
          <!-- ======= -->
          <!-- <div class="discount card" style="--delay: 0.4s">
          ...
          <!-- ====== -->
          <!-- <div class="cards-wrapper" style="--delay: 0.6s">
                ...
                <div class="cards-info">
                  ...
                  <div class="degree">
                    <svg viewBox="0 0 512 512">
                      ...
                      <g fill="#ffd15b">
                        <path
                          d="M320.5 130c-7.4.6-14-5-14.6-12.3l-4.1-47a13.5 13.5 0 0126.9-2.4l4 47c.7 7.4-4.8 14-12.2 14.6z"
                        />
                        <path
                          d="M320.5 130c-7.4.6-14-5-14.6-12.3l-4.1-47a13.5 13.5 0 0126.9-2.4l4 47c.7 7.4-4.8 14-12.2 14.6zM438 228.5c-.6-7.4 4.9-14 12.3-14.6l47-4a13.5 13.5 0 012.4 26.8l-47 4.1c-7.5.7-14-4.8-14.7-12.3zM413 307.7a13.5 13.5 0 0119-1.6l36.2 30.3a13.5 13.5 0 01-17.3 20.7l-36.2-30.4a13.5 13.5 0 01-1.6-19z"
                        />
                        <path
                          d="M413 307.7a13.5 13.5 0 0119-1.6l36.2 30.3a13.5 13.5 0 01-17.3 20.7l-36.2-30.4a13.5 13.5 0 01-1.6-19zM190 120.6a13.5 13.5 0 0119-1.7l36.2 30.4a13.5 13.5 0 01-17.3 20.6l-36.2-30.3a13.5 13.5 0 01-1.7-19zM447.4 98a13.5 13.5 0 011.7 19l-30.4 36.2A13.5 13.5 0 01398 136l30.4-36.2a13.5 13.5 0 0119-1.6z"
                        />
                      </g>
                      <path
          ...
          <!-- <div class="account-wrapper" style="--delay: 0.8s">
        ...
        <!-- user-box first-box end here  -->
        <!-- user-box second-box s here  -->
        <div class="user-box second-box">
          <div class="cards-wrapper" style="--delay: 1s">
            <div class="cards-header">
            <form class="search-tag-wrapper" action="https://www.anjumanehefajoth.com/admin/search.php" method="get">
