...
if(isset($_POST['submit'])){  
 ...
 if(emptyinputourinstitute($title,$descri) == !false ){
      header('location:http://anjumanehefajoth.com/admin/add-ourinstitute.php?error=emptyinput');
      exit();
 }
  inserourinstitute($title,$descri,$imagename,$conn);
 }else{
  header('location:http://anjumanehefajoth.com/admin/add-ourinstitute.php');
  exit();
 }
