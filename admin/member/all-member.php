...
left join division on members.division_id=division.id
...
ORDER BY member_id ASC LIMIT $offset,$limit_per_page";
 ...
 <?php   $i=0;
     	  ...
     	  <tr>
                        <tr>
                          ...
                          <td><?=$row['phone']?></td>
                          <!-- <td><?=$row['email']?></td> -->
                          <td><?=$row['village_name']." ".$row['postoffice_name']." ".$row['upojella_name']." ".$row['district_name']." ".$row['division_name']?></td>
				 ...
				 ?></td>
                          ...
                          <td><a href="edit-member.php?id=<?= $row['member_id']?>" class="btn btn-outline-success btn-sm">Edit</a></td>
                          <td><a href="delet-member.php?id=<?= $row['member_id']?>" class="btn btn-outline-danger btn-sm">Delete</a></td>
                        </tr>
						<?php
			    } 
			?>
