  ...
  <div class="content-wrapper">
    <div class="row">
      ...
      <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">Add writter form</h4>
            <form action="../../includes/add-writter.inc.php" method="post" enctype="multipart/form-data" class="forms-sample">
              <?php
              if (isset($_GET['msg'])) {
              ...
              <div class="form-group">
                <label for="exampleInputName1">লেখকের নাম</label>
                <input type="text" class="form-control" id="exampleInputName1" placeholder="লেখকের নাম" name="writter_name" />
              </div>
              <!-- ================ -->
