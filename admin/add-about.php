        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Add aboutus form</h4>
                  <form action="https://www.anjumanehefajoth.com/includes/add-about.inc.php" method="post"  enctype="multipart/form-data" class="forms-sample" accept-charset="utf-8">
                    <?php
                    if(isset($_GET['msg'])){
