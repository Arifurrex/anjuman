                  ...
                  <table class="table table-striped">
                    ...
                    while($row=mysqli_fetch_assoc($result)){ ?>
                      <tr>
                        ...
                        <td><a href="edit-district.php?id=<?=$row['district_id']?>" class="btn btn-outline-success btn-sm">Edit</a></td>
                        <td><a href="delete-district.php?id=<?=$row['district_id']?>" class="btn btn-outline-danger btn-sm">Delete</a></td>
