                  ...
                  <table class="table table-striped">
                    ...
                    while($row=mysqli_fetch_assoc($result)){ ?>
                      <tr>
                        ...
                        <td><a href="edit-position.php?id=<?=$row['position_id']?>" class="btn btn-outline-success btn-sm">Edit</a></td>
                        <td><a href="delete-position.php?id=<?=$row['position_id']?>" class="btn btn-outline-danger btn-sm">Delete</a></td>
