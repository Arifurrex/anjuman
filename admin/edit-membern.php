              ...
              ?>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <select class="form-control" name="upojella_id" id="upojella" required> 
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                         ...
                         ?>
                          <div class="col-sm-9">
                            <select class="form-control" name="village_id" id="" required>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          ?>
                          <div class="col-sm-9">
                            <select class="form-control" name="position_id" id="" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Village</label>
                          <div class="col-sm-9">
                            <select class="form-control" name="blood_group_id" id="" required>
